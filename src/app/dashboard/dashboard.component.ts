  ...
  constructor(public auth: AuthService,
    ...
    this.auth.clientSystem.subscribe(clientSystem => {
      if (clientSystem) {
        ...
        this.contacts = this.afs.colWithIds$<Invoice>(`client_systems/${clientSystem.id}/contacts`, ref => ref.where('ContactStatus', '==', 'ACTIVE'))
      } else {
        this.invoicesPayable = Observable.of(null)
        this.invoicesReceivable = Observable.of(null)
        this.contacts = Observable.of(null)
      }
    })
  }
